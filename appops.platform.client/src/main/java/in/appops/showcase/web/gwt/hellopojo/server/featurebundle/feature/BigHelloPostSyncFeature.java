...
public class BigHelloPostSyncFeature extends BaseFeature {

	public BigHelloPostSyncFeature(Injector injector) {
		super(injector);
	...
	//System.out.println("First BIG post / sync / hook executed.. :) ");
		return null;
	}
