...
public class QueryThoughtField extends IntelliThoughtField implements FieldEventHandler{
	...
	private void showSuggestionsForLevel(int level,String entityName) {
		try {
			...
			if (level == FIRST) {
				...
				if(tableVsPropMap!=null && tableVsPropMap.get(entityName)!=null){
	...
	@SuppressWarnings("unchecked")
	private void getSuggestionForLevel(String opName, String queryName,String paramName, final Long paramValue, final String entityPropToDisplay) {
