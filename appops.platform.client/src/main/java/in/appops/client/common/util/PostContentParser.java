...
public class PostContentParser {
	    	...
	    	for(int nodeCnt = 0; nodeCnt < childNodeList.getLength(); nodeCnt++){
	    		...
	    		if (childNode.getNodeType() == Node.ELEMENT_NODE) {
				      ...
				      if(tagName.equalsIgnoreCase("link")){
				    	  ...
				    	  labelField.setConfiguration(getLabelFieldConfiguration(true, "postLabel", null, null,text,"activitySnippetLabelPanel"));
	...
	private Configuration getLabelFieldConfiguration(boolean allowWordWrap, String primaryCss, String secondaryCss, String debugId,String displayText, String basePanelCss){
		Configuration configuration = new Configuration();
		...
		configuration.setPropertyByName(LabelFieldConstant.BF_BASEPANEL_PCLS, basePanelCss);
		return configuration;
	}
