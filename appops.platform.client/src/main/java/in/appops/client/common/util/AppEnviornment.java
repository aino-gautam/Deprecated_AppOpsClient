...
public class AppEnviornment {
	...
	public static Entity CURRENTSCHEMA = null;
	...
	public static Entity getCurrentSchema() {
		return CURRENTSCHEMA;
	}

	public static void setCurrentSchema(Entity schemaEntity) {
		CURRENTSCHEMA = schemaEntity;
	}
}
